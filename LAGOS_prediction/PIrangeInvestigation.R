...
# Group data in high PI and low PI with a cutoff of 6.2 (500 mg/L)
# Group data in high PI and low PI with a cutoff of 5.611329 (top 10%)

test = allLagos.out %>% mutate(group = ifelse(PIrange > 5.611329, 'High PI','Low PI')) %>% 
