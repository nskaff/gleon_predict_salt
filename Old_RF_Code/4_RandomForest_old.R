...
#r2 at high values
plot(oob_preds_combined[dat_rf$Chloride>5.4]~dat_rf$Chloride[dat_rf$Chloride>5.4], main=cor(oob_preds_combined[dat_rf$Chloride>5.4], dat_rf$Chloride[dat_rf$Chloride>5.4]) ^ 2)
abline(0,1, col="red")
