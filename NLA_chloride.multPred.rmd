...
```{r setup}
dat = read_csv("data/GLEON NLA data combined 2007 and 2012_first_visit.csv") # note: read_csv needs packages above installed
...
forest = 0.01 * (dat$PCT_FOREST_BSN- mean(dat$PCT_FOREST_BSN, na.rm=T)) #centered predictor - as proportion
